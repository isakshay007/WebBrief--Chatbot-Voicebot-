...
st.title("WebBrief(Built using Lyzr SDK's)")
st.markdown("### Welcome to WebBrief🌐")
st.markdown("With pre-defined prompts and custom queries, uncover valuable insights and create notes effortlessly.")
...
with st.expander("ℹ️ - About this App"):
    st.markdown("""
   WebBrief is an intuitive tool designed to streamline website exploration and note-taking. With a combination of pre-defined prompts and user-generated queries, users can quickly uncover valuable insights from websites and generate concise notes effortlessly.
    """)
